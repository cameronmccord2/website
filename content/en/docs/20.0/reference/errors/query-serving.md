...
| VT09026 |  | Recursive Common Table Expression '%!s(MISSING)' should contain a UNION | 3573 | HY000 |
| VT09027 |  | Recursive Common Table Expression '%!s(MISSING)' can contain neither aggregation nor window functions in recursive query block | 3575 | HY000 |
